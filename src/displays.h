...
// TODO: either pick u8g2 fonts being sized as the previously ones, or convert the previosly used ones to work with u8g2
#define TINY_FONT u8g2_font_profont10_tf
#define SMALL_FONT u8g2_font_profont12_tf
#define MEDIUM_FONT u8g2_font_logisoso20_tf
#define LARGE_FONT u8g2_font_logisoso34_tf
#define HUGE_FONT u8g2_font_logisoso50_tf
...
class DisplayDevice {
  private:
    ...
    // U8G2_SSD1306_128X64_NONAME_F_HW_I2C* m_display; // original OBS display
    // U8G2_UC1601_128X64_F_HW_I2C* m_display; // JHDLCM G98 display
    // U8G2_ST7567_JLX12864_F_4W_HW_SPI* m_display; // JHDLCM G156 display
    String gridText[ 4 ][ 6 ];
  ...
  public:
    DisplayDevice() {
      m_display = new U8G2_SSD1306_128X64_NONAME_F_HW_I2C(U8G2_R0, U8X8_PIN_NONE); // original OBS display
      // m_display = new U8G2_UC1601_128X64_F_HW_I2C(U8G2_R0); // JHDLCM G98 display
      // m_display = new U8G2_ST7567_JLX12864_F_4W_HW_SPI(U8G2_R0, 21, 22); // JHDLCM G156 display
      m_display->begin();
