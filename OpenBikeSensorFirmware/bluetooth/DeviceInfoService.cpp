...
void DeviceInfoService::setup(BLEServer *pServer) {
  ...
  BLECharacteristic *pSystemIDCharcateristic = mService->createCharacteristic(SERVICE_DEVICE_CHAR_SYSTEMID_UUID,
  ...
  BLECharacteristic *pModelNumberStringCharacteristic = mService->createCharacteristic(
  ...
  BLECharacteristic *pSerialNumberStringCharacteristic = mService->createCharacteristic(
  ...
  BLECharacteristic *pFirmwareRevisionCharacteristic = mService->createCharacteristic(
  ...
  BLECharacteristic *pHardwareRevisionCharacteristic = mService->createCharacteristic(
  ...
  BLECharacteristic *pSoftwareRevisionCharacteristic = mService->createCharacteristic(
  ...
  BLECharacteristic *pManufacturerNameCharacteristic = mService->createCharacteristic(
